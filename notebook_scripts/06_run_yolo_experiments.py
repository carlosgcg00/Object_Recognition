# notebook_scripts/06_run_yolo_experiments.py
import sys
    ...
    for experiment in list_experiments:
        ...
        for fold_idx, yaml_file in enumerate(fold_configs):
            ...
            train_yolo_pipeline(
                ...
                epochs_tl=EPOCHS_TL, epochs_ft=EPOCHS_FT, batch_size=BATCH_SIZE, weight_decay=WEIGHT_DECAY, dropout_rate=DROPOUT, warmup_epochs=WARMUP_EPOCHS,
                img_size=IMG_SIZE, lr_tl=LR_TL, lr_ft=LR_FT, optimizer_str=OPTIMIZER,
                mosaic_prob=1.0, # Enable augmentations
                class_order=class_order, # Ensure class order is consistent
            )
